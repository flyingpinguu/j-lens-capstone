...
SETTINGS = {
    ...
    # --- Stage-2 analysis. Input is the multi-turn sys_strict run over the
    #     authorization corpus (random one-token secret per conversation,
    #     16 prompt-end readout positions); set to None to use the Stage-1
    #     output file instead. The earlier single-turn, fixed-secret file
    ...
    "analysis_input_file": ROOT / "outputs" / "j-lens-run" / (
        ...
        "full-corpus-last-16-positions-top10.jsonl"
    ),
